...
class Discriminator(nn.Module):
  ...
  def __init__(self,num_features):
    ...
    self.main = nn.Sequential(
      ...
      # INPUT: bs, 3, 64, 64
      nn.Conv2d(3, num_features, kernel_size=4, stride=2, padding=1, bias=False),
      ...
      ## ConvBlocks 
        # out_channels = 2 * in_channels
        # halves filter dimensions
      ConvBlock(in_channels = num_features),
      # OUTPUT: bs, 128, 16,16
      ConvBlock(in_channels = num_features * 2),
      # OUTPUT: bs, 256, 8, 8 
      ConvBlock(in_channels = num_features * 4),
      # OUTPUT: bs, 512,4,4
